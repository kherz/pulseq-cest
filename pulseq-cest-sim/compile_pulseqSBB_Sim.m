...
if ispc && contains(csn, 'MSVCPP')
    mex CXXOPTIMFLAGS="/O2" -Isrc/3rdParty/eigen-eigen-5a0156e40feb -Isrc/3rdParty/pulseq-master/src/ src/Sim_pulseqSBB.cpp src/SimulationParameters.cpp src/3rdParty/pulseq-master/src/ExternalSequence.cpp
